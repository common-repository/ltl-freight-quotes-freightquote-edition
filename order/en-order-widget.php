 ...
 * Order widget page.
 */
if (!class_exists('Freightquote_EnOrderWidget')) {

    class Freightquote_EnOrderWidget
    {
        ...
        function en_order_actions($actions, $order)
        {
            ...
            add_meta_box('en_additional_order_details', __('Additional Order Details', 'eniture-freightquote-ltl'), [$this, 'en_order_widget'], get_current_screen()->id, 'side', 'low', 'core');
        ...
        public function en_show_accessorials($accessorials)
        {
            $en_accessorials = [
                ...
                'liftgate_pickup' => 'Lift gate pickup',
    ...
    new Freightquote_EnOrderWidget();
}