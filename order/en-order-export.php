 ...
 * Order export.
 */
if (!class_exists('Freightquote_EnOrderExport')) {

    class Freightquote_EnOrderExport
    {
        ...
        public function en_async_cron_schedule($schedules)
        {
            $schedules['en_async_cron_every_5_minute'] = array(
                'interval' => 60 * 5,
                'display' => __('Every 5 minute', 'eniture-freightquote-ltl'),
            );
            return $schedules;
        }
        ...
        public function en_orders_sending($orders, $en_orders_ids)
        {
            ...
            $curl_obj = new Freightquote_LTL_Curl_Request();
            $response = $curl_obj->freightquote_ltl_get_curl_response($url, $post_data);
    ...
    new Freightquote_EnOrderExport();
}