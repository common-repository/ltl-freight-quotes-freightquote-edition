...
if (!class_exists('Freightquote_EN_Plugin_Calculate_Size')) {

    class Freightquote_EN_Plugin_Calculate_Size {
        ...
        function set_line_items($line_item, $locationId) {
            ...
            return $this->freightquote_smpkg_box_items();
        }

        function freightquote_smpkg_box_items() {
