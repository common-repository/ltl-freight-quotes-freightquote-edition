...
if (!defined('ABSPATH')) {
    ...
    {
        function freightquote_en_woo_wd_admin_script_style() 
        {
            ...
            wp_register_style('warehouse_section', plugin_dir_url(__FILE__) . '/wild/assets/css/warehouse_section.css', false, '1.0.5');
            wp_enqueue_style('warehouse_section');
        }

        add_action('admin_enqueue_scripts', 'freightquote_en_woo_wd_admin_script_style');
    }
    
    /**
     * Warehouse Template
     */
    if(!function_exists('freightquote_warehouse_template'))
    {
        function freightquote_warehouse_template($action = FALSE){
                ...
                if (count($warehous_list) > 0) {
                    ...
                    foreach ($warehous_list as $list) {
                        ...
                        <tr class="<?php echo (strlen($tr_disabled_me) > 0 && $count != 0) ? esc_attr( $tr_disabled_me ) : ""; ?>" id="row_<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>" data-id="<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>">
                            ...
                            <td class="en_wd_warehouse_list_data">
                                <a href="javascript(0)" onclick="return en_wd_edit_warehouse(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo esc_url_raw(plugins_url()); ?>/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/edit.png" title="Edit"></a>
                                <a href="javascript(0)" onclick="return en_wd_delete_current_warehouse(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo esc_url_raw(plugins_url()); ?>/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/delete.png" title="Delete"></a>
                            </td>
                        </tr>
                        <?php
                        $count++;
     ...
     * Dropship Template
     */
    if(!function_exists('freightquote_dropship_template'))
    {
        function freightquote_dropship_template($action = FALSE){
                ...
                if (count($dropship_list) > 0) {
                    ...
                    foreach ($dropship_list as $list) {
                        ...
                        <tr class="<?php echo (strlen($tr_disabled_me) > 0 && $count != 0) ? esc_attr( $tr_disabled_me) : ""; ?>" id="row_<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>">
                            ...
                            <td class="en_wd_dropship_list_data">
                                <a href="javascript(0)" onclick="return en_wd_edit_dropship(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo esc_url_raw(plugins_url()); ?>/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/edit.png" title="Edit"></a>
                                <a href="javascript(0)" onclick="return en_wd_delete_current_dropship(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo esc_url_raw(plugins_url()); ?>/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/delete.png" title="Delete"></a>
                            </td>
                        </tr>
                        <?php
                        $count++;
