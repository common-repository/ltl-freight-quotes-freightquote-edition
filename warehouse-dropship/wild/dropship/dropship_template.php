...
<script type="text/javascript">
    ...
    function change_dropship_zip()
    {
        ...
        jQuery('#en_wd_dropship_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw( plugins_url() ); ?>/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw( plugins_url() ); ?>/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        ...
        jQuery('#en_wd_dropship_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw( plugins_url() ); ?>/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
...
<div class="en_wd_setting_section">
    ...
    <?php freightquote_dropship_template(); ?>
            ...
            <div class="content">
                ...
                -->
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" class="<?php echo esc_attr( $disabled ); ?> en-phone-number" title="Phone number:"
