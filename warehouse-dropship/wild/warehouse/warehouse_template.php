...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery("#en_wd_origin_zip").keypress(function (e) {
            var allowedCode = [8, 0, 32];
            if (e.which > 31 && (e.which < 64 || e.which > 90) &&
				(e.which < 97 || e.which > 122) &&
				(e.which < 48 || e.which > 57)&&
				(allowedCode.indexOf(e.which) == -1)) {
				return false;
             }
             else{
    ...
    function change_warehouse_zip()
    {
        ...
        jQuery('#en_wd_origin_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw(plugins_url()); ?>/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw(plugins_url()); ?>/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('.city_select_css').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw(plugins_url()); ?>/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw(plugins_url()); ?>/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
...
<div class="en_wd_setting_section">
    ...
    <?php freightquote_warehouse_template(); ?>
            ...
            <div class="content" style="overflow-y: auto; height: 80vh;">
                ...
                <form method="post" id="add_warehouses">
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" class="numericonly"  maxlength="8" title="Handling Fee / Markup" name="en_wd_origin_markup" data-optional="1" value="" 
                        placeholder="e.g Currency 1.00 or percentage 5%" id="en_wd_origin_markup">
                    </div>
