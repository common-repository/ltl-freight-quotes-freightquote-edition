...
if (!class_exists("Freightquote_EnWooWdAddonsAjaxReqIncludes")) {

    class Freightquote_EnWooWdAddonsAjaxReqIncludes
    {
        ...
        function get_address_api_ajax()
        {
            if (isset($_POST['origin_zip'])) {
                ...
                $accessLevel = 'address';
                $FreightQuote_Get_ltl_distance = new Freightquote_Get_ltl_distance();
                $resp_json = $FreightQuote_Get_ltl_distance->freightquote_ltl_get_distance($zipCode, $accessLevel);
                ...
                if (isset($validateData["city"])) {
                    ...
                    if ($get_warehouse_id && (empty($get_warehouse) || (!empty($get_warehouse) && reset($get_warehouse)->id == $get_warehouse_id))) {
                        ...
                        if (empty($get_warehouse)) {
                            ...
                            $html = freightquote_warehouse_template(TRUE);
                        }
                    }
                }
                ...
                if (isset($validateData["city"])) {
                    ...
                    if ($get_dropship_id != '' && (empty($get_dropship) || (!empty($get_dropship) && reset($get_dropship)->id == $get_dropship_id))) {
                        ...
                        if (empty($get_dropship)) {
                            ...
                            $html = freightquote_dropship_template(TRUE);
                        }
                    }
                }
                $lastid = $wpdb->insert_id;
...
new Freightquote_EnWooWdAddonsAjaxReqIncludes();