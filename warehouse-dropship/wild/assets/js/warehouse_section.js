    jQuery(document).ready(function() {
        ...
        // Origin terminal address
        // Terminal phone number
        jQuery("#en-phone-number, #en_wd_origin_address, #en_wd_origin_zip, #en_wd_origin_city, #en_wd_origin_state, #en_wd_origin_country, #instore-pickup-address, #instore-pickup-desc,  #local-delivery-address, #local-delivery-desc, #local-delivery-fee, #en_wd_origin_markup").focus(function (e) {
   ...
   if(typeof load_inside_pikup_and_local_delivery_data != 'function')
    ...
    if(typeof en_wd_save_warehouse != 'function')
    {
        function en_wd_save_warehouse()
        {
            ...
            /*var instore_pickup_address_val = jQuery('#instore-pickup-address').val();
            var local_delivery_fee_val = jQuery('#local-delivery-fee').val();
            var regex_for_valid_positive_dec = /^((\d+(\\.\d{0,2})?)|((\d*(\.\d{1,2}))))$/;
            if (instore_pickup_address_val != '' && regex_for_valid_positive_dec.test(instore_pickup_address_val) == false) {
            ...
            if (local_delivery_fee_val != '' && regex_for_valid_positive_dec.test(local_delivery_fee_val) == false ) {
            ...
            jQuery.ajax({
                ...
                success: function (data)
                {
                    ...
                    if (data.insert_qry == 1) {
                        ...
                        jQuery('.dropship_created').css('display', 'none');
                        window.location.href = jQuery('.close').attr('href');
                        jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_warehouse_list_data">' + data.origin_city + '</td><td class="en_wd_warehouse_list_data">' + data.origin_state + '</td><td class="en_wd_warehouse_list_data">' + data.origin_zip + '</td><td class="en_wd_warehouse_list_data">' + data.origin_country + '</td><td class="en_wd_warehouse_list_data"><a href="javascript(0)" title="Edit" onclick="return en_wd_edit_warehouse(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_warehouse(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
                    }
                    else {
            ...
            jQuery.ajax({
                ...
                success: function (data)
                {
                    ...
                    if (data.insert_qry == 1) {
                        ...
                        jQuery('.warehouse_created').css('display', 'none');
                        window.location.href = jQuery('.close').attr('href');
                        jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_dropship_list_data">' + data.nickname + '</td><td class="en_wd_dropship_list_data">' + data.origin_city + '</td><td class="en_wd_dropship_list_data">' + data.origin_state + '</td><td class="en_wd_dropship_list_data">' + data.origin_zip + '</td><td class="en_wd_dropship_list_data">' + data.origin_country + '</td><td class="en_wd_dropship_list_data"><a href="javascript(0)" title="Edit" onclick="return en_wd_edit_dropship(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_dropship(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-freightquote-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
                    }
                    else {
                        jQuery('.already_exist').show('slow');
                        jQuery( '.content' ).delay( 200 ).animate({scrollTop: 0 }, 300);
