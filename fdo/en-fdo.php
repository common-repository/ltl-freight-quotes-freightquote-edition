...
class Freightquote_EnFdo
{
    ...
    public function en_cart_package($package)
    {
        ...
        $this->en_fdo_meta_data['plugin_name'] = 'freightquote_quests';
        $accessorials['residential'] = get_option('wc_settings_freightquote_residential_delivery') == 'yes' ? true : false;
        $accessorials['liftgate'] = get_option('wc_settings_freightquote_lift_gate_delivery') == 'yes' ? true : false;
        $accessorials['liftgate_pickup'] = get_option('wc_settings_freightquote_lift_gate_pickup') == 'yes' ? true : false;
