 ...
 * Class Freightquote_EnFreightProductDetail
 * @package Freightquote_EnFreightProductDetail
 */
if (!class_exists('Freightquote_EnFreightProductDetail')) {
    ...
    class Freightquote_EnFreightProductDetail
    {
        ...
        /**
         * Hook for call.
         * Freightquote_EnFreightProductDetail constructor.
         */
        public function __construct()
        {
            add_filter('en_app_common_plan_status', [$this, 'en_freightquote_freight_plan_status'], 10, 1);
         ...
         * @return array
         */
        public function en_freightquote_freight_plan_status($plan_status)
        {
            $en_plugin_name = 'LTL Freight Quotes – FreightQuote Edition';
            ...
            $plan_status['hazardous_material']['freightquote_freight'][] = 'freightquote_freight';
            ...
            $nesting_material = apply_filters("freightquote_quests_quotes_plans_suscription_and_features", 'nested_material');
            if (is_array($nesting_material)) {
                $plan_required = '1';
                $nested_material_status = $en_plugin_name . ': Upgrade to Advanced Plan to enable.';
            }

            $plan_status['nesting']['freightquote_freight'][] = 'freightquote_freight';
        ...
        {
            $classification = [
                '0' => __('No Freight Class', 'eniture-freightquote-ltl'),
                '50' => __('50', 'eniture-freightquote-ltl'),
                '55' => __('55', 'eniture-freightquote-ltl'),
                '60' => __('60', 'eniture-freightquote-ltl'),
                '65' => __('65', 'eniture-freightquote-ltl'),
                '70' => __('70', 'eniture-freightquote-ltl'),
                '77.5' => __('77.5', 'eniture-freightquote-ltl'),
                '85' => __('85', 'eniture-freightquote-ltl'),
                '92.5' => __('92.5', 'eniture-freightquote-ltl'),
                '100' => __('100', 'eniture-freightquote-ltl'),
                '110' => __('110', 'eniture-freightquote-ltl'),
                '125' => __('125', 'eniture-freightquote-ltl'),
                '150' => __('150', 'eniture-freightquote-ltl'),
                '175' => __('175', 'eniture-freightquote-ltl'),
                '200' => __('200', 'eniture-freightquote-ltl'),
                '225' => __('225', 'eniture-freightquote-ltl'),
                '250' => __('250', 'eniture-freightquote-ltl'),
                '300' => __('300', 'eniture-freightquote-ltl'),
                '400' => __('400', 'eniture-freightquote-ltl'),
                '500' => __('500', 'eniture-freightquote-ltl'),
                'DensityBased' => __('Density Based', 'eniture-freightquote-ltl')
            ];
        ...
        {
            $dropship = $this->get_dropship_data();
            $en_dropship_list = [];
         ...
         */
        public static function get_dropship_data()
        {
            global $wpdb;
            $en_table_name = $wpdb->prefix . 'warehouse';
            return (array)$wpdb->get_results("SELECT * FROM $en_table_name WHERE location = 'dropship'", ARRAY_A);
        }
        ...
        public function en_app_common_plan_status()
        {
            ...
            if (isset($plan_status['hazardous_material'])) {
                if (!in_array(0, $plan_status['hazardous_material']['plan_required'])) {
                    ...
                    $this->hazardous_plan_required = apply_filters("freightquote_quests_plans_notification_link", [2, 3]);
    ...
    new Freightquote_EnFreightProductDetail();
}